...
class ShoppingProfileEdit extends StatefulWidget {
  @override
  _ShoppingProfileEditState createState() => _ShoppingProfileEditState();
}

class _ShoppingProfileEditState extends State<ShoppingProfileEdit> {
                    ...
                    children: <Widget>[
                      ...
                      Text("Marcelina Willis",
                          style: AppTheme.getTextStyle(
                              ...
                              fontWeight: 600,
                              letterSpacing: 0)),
                      Text(Translator.translate("text_silver_member"),
                          style: AppTheme.getTextStyle(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: Translator.translate("text_name"),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            fillColor: customAppTheme.bgLayer3,
                            prefixIcon:
                                Icon(MdiIcons.email, size: MySize.size24),
                            contentPadding: EdgeInsets.all(0),
                          ),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          style: AppTheme.getTextStyle(
                              ...
                              fontWeight: 500),
                          decoration: InputDecoration(
                            hintText: Translator.translate("text_phone"),
                            hintStyle: AppTheme.getTextStyle(
                                themeData.textTheme.subtitle2,
                                letterSpacing: 0.1,
                                color: themeData.colorScheme.onBackground,
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText:
                                Translator.translate("text_change_password"),
                            hintStyle: AppTheme.getTextStyle(
                                themeData.textTheme.subtitle2,
                                letterSpacing: 0.1,
                                color: themeData.colorScheme.onBackground,
                      ...
                      Container(
                        ...
                        child: FlatButton(
                            ...
                            child: Text(
                                Translator.translate("text_update")
                                    .toUpperCase(),
                                style: AppTheme.getTextStyle(
