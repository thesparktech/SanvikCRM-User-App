...
class ShoppingOnboarding2Screen extends StatefulWidget {
  ShoppingOnboarding2Screen({Key key}) : super(key: key);

  @override
  _ShoppingOnboarding2ScreenState createState() =>
      _ShoppingOnboarding2ScreenState();
}

class _ShoppingOnboarding2ScreenState extends State<ShoppingOnboarding2Screen> {
  @override
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Center(
                                  child: Image(
                                image: AssetImage(
                                    './assets/illustration/illu-4.png'),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Center(
                                  child: Image(
                                image: AssetImage(
                                    './assets/illustration/illu-5.png'),
                                width: MySize.getScaledSizeHeight(300),
                                height: MySize.getScaledSizeHeight(320),
                              )),
                              SizedBox(height: MySize.size30),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Center(
                                  child: Image(
                                image: AssetImage(
                                    './assets/illustration/illu-6.png'),
                                width: MySize.getScaledSizeHeight(300),
                                height: MySize.getScaledSizeHeight(320),
                              )),
                              SizedBox(height: MySize.size30),
